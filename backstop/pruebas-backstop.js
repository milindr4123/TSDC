...
const testDir = 'C:\\Users\\ASUS\\Desktop\\Uniandes\\Ciclo 2\\PruebasAutomatizadas\\repoProyecto\\TSDC\\kraken\\reports\\F3-S1-version-5';
const referenceDir = 'C:\\Users\\ASUS\\Desktop\\Uniandes\\Ciclo 2\\PruebasAutomatizadas\\repoProyecto\\TSDC\\kraken\\reports\\F3-S1-version-3';
...
fs.readdirSync(referenceDir).forEach(file => {
    if (fs.existsSync(`${referenceDir}/${file}`) && fs.existsSync(`${testDir}/${file}`)){
        ...
        scenarios.push({
            "label": file,
            "referenceUrl": "C:\\Users\\ASUS\\Desktop\\Uniandes\\Ciclo 2\\PruebasAutomatizadas\\repoProyecto\\TSDC\\kraken\\reports\\F3-S1-version-3\\"+file,
            "url": "http://127.0.0.1:8080/F3-S1-version-5/"+file,
            "readyEvent": "",
            "delay": 1000,
